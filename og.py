...
TOKEN = '7492176838:AAEiP67H14BMy9ScVOT_A8ke0Qv7aa5XywQ'
YOUR_OWNER_ID = 1383324178  # Replace with your actual owner ID

bot = telebot.TeleBot('7492176838:AAEiP67H14BMy9ScVOT_A8ke0Qv7aa5XywQ')
...
def resellership_info(message):
    bot.send_message(message.chat.id, "Contact @CRACKWARS_DANZER for reseller ship.")
